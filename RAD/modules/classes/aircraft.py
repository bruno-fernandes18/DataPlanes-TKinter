...
class Aircraft:
    def __init__(self, Technical_obj: Technical = None, Take_off_obj: Take_off = None, Initial_climb_obj: Flight_level = None, Climb_150_obj: Flight_level = None, Climb_240_obj: Flight_level = None, Climb_mach_obj: Flight_level = None, Cruise_obj: Cruise = None, Initial_descent_obj: Flight_level = None, Descent_100_obj: Flight_level = None, Approach_obj: Approach = None, Landing_obj: Landing = None):
        try:
    ...
    def debug_airplane(self):
        try:
            self.technical = Technical('Boeing',1996,'737','737-700',34.3,'Low','Underwing','Regular','Trycicle',33.6,12.6)
    ...
    def plane_to_dict(self) -> dict:
        try:
            ...
            aircraft_dict['image'] = './images/' + self.technical.variation + '.png'
