...
class App:
    ...
    def open_airplane(self):
        ...
        if ids:
            ...
            messagebox.showwarning('Empty Database','The Database is empty. Why not try adding plane?')
            return False
    ...
    def manager_package(self) -> tuple:
        ...
        try:
            ...
            messagebox.showwarning('Alert','The Database is empty. Why not try adding plane?')
            return None
